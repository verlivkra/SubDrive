...
DTU           10MW          - Reference turbine extended to include drivetrain model in SubDyn
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"DTU_10MW_DrTr_ElastoDyn.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"Control\DTU_10MW_RWT_ServoDyn.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
"unused"      SeaStFile       - Name of file containing sea state input parameters (quoted string)
"Hydro\DTU_10MW_DrTr_HydroDynWS12.dat" HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"Tower\DTU_10MW_DrTr_SubDyn.dat" SubFile       - Name of file containing sub-structural input parameters (quoted string)
