...
if __name__ == '__main__':
    ...
    predefined_case = 'DTU10MW_floating' #'DTU10MW_floating_towerOnly' # Any of 'DTU10MW_landbased', 'DTU10MW_monopile', 'IEA15MW_floating'
    ...
    elif predefined_case == 'DTU10MW_floating':
        cases.floating(script_dir, 'tower_from_elastodyn', 'straight_beam', 'DTU10MW_mediumspeed', 'DTU10MW_mediumspeed', add_nacelle_yaw_inertia= False, add_yaw_br_mass = False)
    elif predefined_case == 'DTU10MW_floating_towerOnly':
        cases.floating_towerOnly(script_dir, 'tower_from_elastodyn', 'straight_beam', 'DTU10MW_mediumspeed', 'DTU10MW_mediumspeed', add_nacelle_yaw_inertia= False, add_yaw_br_mass = False)
