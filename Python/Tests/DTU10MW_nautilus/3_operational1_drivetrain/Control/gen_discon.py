...
def write_yaml():
    ...
    path_params = {'FAST_InputFile': 'DTU_10MW_OO_GoM.fst',                 # Name of *.fst file
    ...
    controller_params = {  # Controller flags
                          ...
                          'F_NotchType':        3,                     # Notch on the measured generator speed and/or tower fore-aft motion (for floating) {0- disable, 1- generator speed, 2- tower-top fore- aft motion, 3- generator speed and tower-top fore-aft motion}
                          ...
                          'Fl_Mode':            1,                     # Floating specific feedback mode {0- no nacelle velocity feedback, 1 - nacelle velocity feedback, 2 - nacelle pitching acceleration feedback})
