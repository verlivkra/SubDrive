...
if __name__ == '__main__':
    ...
    predefined_case = 'IEA22MW_monopile'
    # predefined_case = 'IEA15MW_monopile'
    ...
    #     cases.floating(script_dir, 'tower_from_wisdem', 'wisdem_directdrive', 'wisdem_directdrive', 'wisdem_directdrive', add_nacelle_yaw_inertia= True, add_yaw_br_mass = True)
    elif predefined_case == 'IEA15MW_monopile':
        cases.monopile(script_dir, 'tower_from_elastodyn', 'wisdem_directdrive', 'wisdem_directdrive', 'wisdem_directdrive', add_nacelle_yaw_inertia= True, add_yaw_br_mass = True)
    elif predefined_case == 'IEA15MW_monopile_towerOnly':
        cases.monopile_towerOnly(script_dir, 'tower_from_elastodyn', 'wisdem_directdrive', 'wisdem_directdrive', 'wisdem_directdrive', add_nacelle_yaw_inertia= True, add_yaw_br_mass = True)
        ...
        cases.floating(script_dir, 'tower_from_wisdem', 'wisdem_directdrive', 'wisdem_directdrive', 'wisdem_directdrive', add_nacelle_yaw_inertia= True, add_yaw_br_mass = True)
    elif predefined_case == 'IEA22MW_monopile':
        cases.monopile(script_dir, 'tower_from_elastodyn', 'wisdem_directdrive', 'wisdem_directdrive', 'wisdem_directdrive', add_nacelle_yaw_inertia= True, add_yaw_br_mass = True)
