...
DTU           10MW          - RWT - Monopile (monopile based on the IEA 10 MW RWT)
---------------------- SIMULATION CONTROL --------------------------------------
...
"DTU_10MW_RWT_HydroDyn.dat"      HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"..\Tower\OC6_phaseII_Monopile_SubDyn_Coarse.dat" SubFile       - Name of file containing sub-structural input parameters (quoted string)
